...
const RUNS_COUNT = 200;

console.log('run measure  particle-flux performance');
console.log(measureFuncExecuteTime(testParticleFluxPerformance(), RUNS_COUNT));
...
console.log(measureFuncExecuteTime(testPixiParticleEmitterPerformance(), RUNS_COUNT));
